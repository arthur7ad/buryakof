...
$this->registerCssFile('/css/landing/pereezd-mezhgorod.css');
...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
                    ...
                    <div class="content">
                        ...
                        <div id="usl">
                            ...
                            \app\modules\link_block\widgets\LinkBlockWidget::widget([
                                'sysname' => 'pereezd_mezh_landing', 'count' => 4
                            ])
                            ?>
                        ...
                        <div class="tar-wrap">
                            ...
                            <div id="tar" class="h2 header-line">Тарифы переезды</div>

                            <div class="container">

                                <?= app\modules\tarif\widgets\PereezdMezhGorodSlider::widget() ?>
                        ...
                        <div class="tar-wrap">
                            ...
                            <div id="tar" class="h2 header-line">Тарифы грузоперевозки</div>

                            <div class="container">

                                <?= app\modules\tarif\widgets\GruzMezhGorodSlider::widget() ?>
        ...
        <?php echo Yii::$app->info::get('counter_landing_pereezd-mezhgorod'); ?>
        <?php $this->endBody() ?>
    </body>
</html>
<?php $this->endPage() ?>
