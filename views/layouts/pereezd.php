...
/*        ------------      */
/*           Шаблони для домашних переездов   */
/*        ------------      */
...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="page">
            <div class="wrap">
                ...
                <?= app\modules\slider\widgets\MainSlider::widget(['system_name' => 'home_pereezd']) ?>
 ...
 <div class="calc color-slide" style="margin-bottom: 6rem;">
                            <div class="container">
                                ...
                                <div class="h2 header-line" style="margin-bottom: 4rem;">Рассчитайте стоимость на калькуляторе</div>
                ...
                <?= $this->render('_pereezd_price') ?>

                <?= \app\modules\link_block\widgets\LinkBlockWidget::widget(['sysname' => 'pereezdy_1']) ?>
